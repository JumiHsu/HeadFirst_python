# -*- coding: utf-8 -*-
"""
Created on Wed Oct 18 17:42 2018
...
if ans=="N":
    ...
    # send_to_twitter()
    twitter_print("咖啡豆已用盡！立即下訂單！當前價格為：")
    twitter_print(make_price())
    ...
    while price>boss:
        ...
        if price <= boss:
            ...
            twitter_print("Hello, Boss! 咖啡豆價格已經比門檻價格要低了, 請下訂單")
            twitter_print("當前價格為")
            twitter_print(price)
